...
3. One or two members of our team will facilitate the call to ensure that the conversation runs smoothly and stays on time (1 hour). During the call, we will take notes and encourage others to take notes on a collaborative Etherpad. Importantly, we will set the tone for a productive and respectful conversation according to our [Code of Conduct](https://v2.prereview.org/docs/code_of_conduct).
